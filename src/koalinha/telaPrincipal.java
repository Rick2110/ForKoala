...
public class telaPrincipal {
	...
	private void initialize(String usuario) {
		...
		marcarHorario hrs = new marcarHorario(usuario); // Instância da classe marcarHorario
		...
		btnNewButton_1_1.setIcon(new ImageIcon(iconfilePath3));
		...
		btnNewButton_1_1_1.setIcon(new ImageIcon(iconfilePath4));
		btnNewButton_1_1_1.setBorder(BorderFactory.createEmptyBorder());
